...
export default function WorkspaceSwitcher({
  ...
  const { isSettingsModalOpen, setIsSettingsModalOpen, activeSettingsTab, setActiveSettingsTab } =
    useSettings();
        ...
        >
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0 flex items-center justify-between">
              ...
              <ChevronDown
                size={14}
                className="text-muted-foreground flex-shrink-0 ml-1 transition-transform duration-200"
      ...
      {mounted &&
        ...
        createPortal(
          ...
          >
            ...
            <div
              className="p-4 border-b bg-transparent"
              style={{ borderColor: 'rgba(255,255,255,0.04)' }}
            >
              <p className="text-[10px] font-bold text-muted-foreground/30 uppercase tracking-[0.2em] mb-3">
                Current Workspace
              </p>
            ...
            <div className="p-1.5 space-y-0.5 bg-transparent">
              ...
              >
                <User
                  size={14}
                  className="text-muted-foreground/30 group-hover:text-foreground/50 transition-colors"
                />
              ...
              <button
                onClick={() => {
                  setIsOpen(false);
                  setActiveSettingsTab('Billing & Plans');
                  setIsSettingsModalOpen(true);
                }}
                className="w-full flex items-center gap-2.5 px-3 py-2 text-[13px] font-medium rounded-lg hover:bg-white/[0.05] text-foreground/70 transition-all text-left group"
              >
              ...
              <button
                onClick={() => {
                  setIsOpen(false);
                  setActiveSettingsTab('Help & Support');
                  setIsSettingsModalOpen(true);
                }}
                className="w-full flex items-center gap-2.5 px-3 py-2 text-[13px] font-medium rounded-lg hover:bg-white/[0.05] text-foreground/70 transition-all text-left group"
              >
              ...
              >
                <LogOut
                  size={14}
                  className="text-red-500/40 group-hover:text-red-500/60 transition-colors"
                />
                <span>Log out</span>
              </button>
            </div>
